// lib/features/mahasiswa/views/mahasiswa_dashboard.dart
...
class MahasiswaDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Halaman Input Logbook (Mahasiswa)', style: TextStyle(fontSize: 20, color: Colors.blue.shade800))),
    );
  }
}