  ...
  final List<Map<String, dynamic>> _onboardData = [
    {
      ...
      'description': 'Ajukan permintaan bimbingan dengan mudah dan terorganisir.',
    },
    {
      'image': 'assets/images/login/onboard2.png', 
      'title': 'Riwayat Bimbingan',
      'description': 'Lacak dan lihat catatan bimbingan yang telah dilakukan secara menyeluruh.',
    },
    {
      'image': 'assets/images/login/onboard3.png', 
      'title': 'Siap Belajar &\nSiap Dibimbing', 
      'description': 'Bimbingan magang, progres, dan komunikasi dalam satu platform yang praktis.',
    },
  ];
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            if (!isLastPage)
              Positioned(
                top: 10, // Sedikit lebih ke bawah dari edge
                right: 20,
                child: TextButton(
            ...
            Positioned(
              ...
              right: 24,
              child: isLastPage 
                ? Column( // Halaman Terakhir: Tombol Masuk Besar
                    children: [
                      // Indikator Titik
                      _buildDotIndicators(),
                ...
                : Row( // Halaman 1 & 2: Dots + Floating Action Button
